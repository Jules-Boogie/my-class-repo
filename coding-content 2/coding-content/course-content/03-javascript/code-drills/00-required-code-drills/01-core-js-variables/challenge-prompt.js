...
var statementOne = fullName + nationality + profession + birthYear;
...
// much like you did for the console logs and `fullName`
var statementTwo = "She is commonly referred " + knownFor;
...
var statementThree = "In " + yearOfPublish + "she published the, " + firstAlgorithm + ", at the age of " + ageAtYearOfPublish ;
...
var statementFour = "She was a " + nationality + " citizen " + "who lives in " + cityLocation + countryLocation + " until her passing in " + deathYear + " at the age of " + ageAtPassing + ".";
...
// everything printed out properly. I may need to add some spaces.
